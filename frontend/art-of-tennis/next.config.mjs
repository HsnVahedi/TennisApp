...
const nextConfig = {
  env: {
    ...
    NEXTAUTH_URL: process.env.IS_PROD ? `https://aot-web-idoz445l32m-front.happyhill-9bdb3392.eastus.azurecontainerapps.io` : 'http://localhost:3000',
    // NEXTAUTH_URL: process.env.IS_PROD ? `http://artoftennis.us` : 'http://localhost:3000',
    NEXT_PUBLIC_DOMAIN: process.env.IS_PROD ? `https://aot-web-idoz445l32m-front.happyhill-9bdb3392.eastus.azurecontainerapps.io` : 'http://localhost:3000',
