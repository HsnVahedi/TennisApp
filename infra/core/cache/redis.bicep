...
// TODO: Check to see if this redis is secure.
//       It's recommended to use virtual network Since enableNonSslPort it true.
...
// output redisPort int = cache.properties.port
// output redisHost string = cache.properties.hostName
